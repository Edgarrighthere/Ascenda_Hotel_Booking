    ...
    namespace PaymentIntent {
      ...
      namespace NextAction {
        ...
        interface CardAwaitNotification {
          ...
          /**
           * For payments greater than INR 14999, the customer must provide explicit approval of the payment with their bank. For payments of lower amount, no customer action is required.
           */
      ...
      namespace Processing {
        ...
        namespace Card {
          interface CustomerNotification {
            /**
             * Whether customer approval has been requested for this payment. For payments greater than INR 14999 or mandate amount, the customer must provide explicit approval of the payment with their bank.
             */
